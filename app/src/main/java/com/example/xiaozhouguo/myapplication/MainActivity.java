...
public class MainActivity extends Activity implements View.OnClickListener, MineRadioAdapter.OnItemClickListener {
    ...
    private void initData() {
        ...
        mRecyclerview.setMineRadioAdapter(mRadioAdapter);
        for (int i = 0; i < 30; i++) {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.select_all:
                mRadioAdapter.setAnimateMode(false);
                selectAllMain();
                break;
    ...
    private void updataEditMode() {
        ...
        if (mEditMode == MYLIVE_MODE_EDIT) {
            ...
            mLlMycollectionBottomDialog.startAnimation(showAnim);
        ...
        mRadioAdapter.setAnimateMode(true);
    }
    ...
    private void clearAll() {
        ...
        mSelectAll.setText("全选");
        setBtnBackground(0);
        for(MyLiveList myLiveList:mList ){
