...
public class MineRadioAdapter extends RecyclerView.Adapter<MineRadioAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (mEditMode == MYLIVE_MODE_CHECK) {
            if(isAnimate){
                TranslateAnimation showAnim = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0.15f,
                        Animation.RELATIVE_TO_SELF, 0.0f,
                        Animation.RELATIVE_TO_SELF, 0.0f,
                        Animation.RELATIVE_TO_SELF, 0.0f);
                showAnim.setDuration(500);
                holder.mRootView.startAnimation(showAnim);
        }
            ...
            if(isAnimate) {
                ...
                showAnim.setDuration(500);
                holder.mRootView.startAnimation(showAnim);
                holder.mCheckBox.startAnimation(showAnim);
            }
    ...
    public void setAnimateMode(boolean isAnimate){
